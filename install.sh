...
yay -S sway-git wlroots-git nemo wofi waybar mako network-manager-applet foot grim slurp egl-wayland \
  ...
  epapirus-icon-theme arc-gtk-theme qt5ct ttf-nerd-fonts-symbols otf-font-awesome \
  ttf-font-awesome powerline-fonts noto-fonts-emoji noto-fonts-lite noto-fonts-cjk \
  ttf-hack ttf-iosevka
